...
{
	public class AndroidMonoSourceFileList : PosixMonoSourceFileList
	{
		...
		public override IEnumerable<NPath> GetUtilsSourceFiles(Architecture architecture)
		{
			...
			yield return MonoSourceFileList.MonoSourceDir.Combine("mono/utils/mono-log-android.c");
			yield return MonoSourceFileList.MonoSourceDir.Combine("mono/utils/mono-threads-android.c");
		}
	}
}
