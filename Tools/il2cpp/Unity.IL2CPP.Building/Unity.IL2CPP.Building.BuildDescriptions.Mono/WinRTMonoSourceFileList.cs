...
{
	public class WinRTMonoSourceFileList : WindowsSharedMonoSourceFileList
	{
		public override IEnumerable<NPath> GetEGLibSourceFiles(Architecture architecture)
		{
			...
			yield return MonoSourceFileList.MonoSourceDir.Combine("mono/eglib/gunicode-win32-uwp.c");
		}
		...
		public override IEnumerable<NPath> GetUtilsSourceFiles(Architecture architecture)
		{
			...
			yield return MonoSourceFileList.MonoSourceDir.Combine("mono/utils/mono-dl-windows-uwp.c");
		}
	}
}
