...
{
	internal class WindowsDesktopUnitTestPlusPlusBuildDescription : WindowsIL2CPPOutputBuildDescription
	{
		private UnitTestPlusPlusBuildDescription m_UnitTestPlusPlusBuildDescription;

		public WindowsDesktopUnitTestPlusPlusBuildDescription(UnitTestPlusPlusBuildDescription other)
			: base(other)
		{
