...
{
	internal class AndroidUnitTestPlusPlusBuildDescription : AndroidCppRunnerBuildDescription
	{
		private readonly UnitTestPlusPlusBuildDescription _mUnitTestPlusPlusBuildDescription;

		public AndroidUnitTestPlusPlusBuildDescription(UnitTestPlusPlusBuildDescription other)
			: base(other)
		{
