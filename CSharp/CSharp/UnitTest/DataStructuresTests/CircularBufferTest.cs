...
namespace UnitTest.DataStructuresTests 
{
    public class CircularBufferTest 
    {
        ...
        public static void TestingICollectionImplementation() 
        {
          ...
          Assert.AreEqual(24, array[2]);

            //Testing Count
          Assert.AreEqual(3, circularBuffer.Count);
            //Testing clear
            circularBuffer.Clear();
          Assert.AreEqual(0, circularBuffer.Pop());
          Assert.AreEqual(0, circularBuffer.Pop());
          Assert.AreEqual(0, circularBuffer.Pop());
           Assert.IsEmpty(circularBuffer);
        }
        [Fact]
        public static void TestingRemoveMethod() {
          ...
          Assert.AreEqual(3, circularBuffer.Pop());
          Assert.AreEqual(34, circularBuffer.Pop());
          Assert.AreEqual(24, circularBuffer.Pop());
          Assert.AreEqual(31, circularBuffer.Pop());
          Assert.AreEqual(14, circularBuffer.Pop());
          ...
          Assert.AreEqual(5 - 3, circularBuffer.Count);
          ...
          Assert.AreEqual(1, circularBuffer.Pop());
          Assert.AreEqual(2, circularBuffer.Pop());
          Assert.AreEqual(3, circularBuffer.Pop());
          ...
          Assert.AreEqual(2, circularBuffer.Pop());
          Assert.AreEqual(3, circularBuffer.Pop());
          Assert.AreEqual(4, circularBuffer.Pop());
          Assert.AreEqual(5, circularBuffer.Pop());
          ...
          Assert.AreEqual(5, stringBuffer.Count);

          Assert.AreEqual("one", stringBuffer.Pop());
          Assert.AreEqual("two", stringBuffer.Pop());
          Assert.AreEqual("three", stringBuffer.Pop());
          Assert.AreEqual("four", stringBuffer.Pop());
          Assert.AreEqual("five", stringBuffer.Pop());
        }
    }
}
