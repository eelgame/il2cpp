...
namespace UnitTest.DataStructuresTests
{
    public static class HashTableSeparateChainingTest
    {
        ...
        public static void Adding_TwoDuplicateElements_ReturnsException()
        {
           ...
           //Assert.AreEqual("Key already exists in the hash table.", exception.Message);
        ...
        public static void CopyTo_FilledHashTable_ReturnsSuccessful()
        {
          ...
          Assert.AreEqual("Name1", arrayKeys[0]);
          Assert.AreEqual("Name2", arrayKeys[1]);
          Assert.AreEqual("Name3", arrayKeys[2]);
            var arrayValues = array.Select(x => x.Value).OrderBy(x => x).ToArray();
          Assert.AreEqual(1, arrayValues[0]);
          Assert.AreEqual(3, arrayValues[1]);
          Assert.AreEqual(5, arrayValues[2]);
