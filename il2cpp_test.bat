...
.\il2cpp\build\deploy\netcoreapp3.1\il2cpp.exe --compile-cpp --libil2cpp-static --configuration=Release --forcerebuild --generate-cmake=il2cpp --dotnetprofile="unityaot" --baselib-directory=.\windowsstandalonesupport\Variations\win64_nondevelopment_il2cpp --platform=WindowsDesktop --architecture=x64 --outputpath=./output/GameAssembly-CSharp-x64/GameAssembly-CSharp-x64.dll --generatedcppdir=./output/CSharp --cachedirectory=./output/GameAssembly-CSharp-x64/cache
pause